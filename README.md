...
| `PUBLIC_PATH_PREFIX` | `/drop` | URL path prefix for published dashboards (e.g. `/drop`, `/d`, `/view`) |
...
| `GET` | `{PUBLIC_PATH_PREFIX}/{slug}` | Serve published HTML (404 if archived; default `/drop/{slug}`) |
